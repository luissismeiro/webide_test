sap.ui.define([
		...
		opaTest("MasterList Filtering on Netwr less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("<Netwr>").
				and.iSelectListItemInViewSettingsDialog("<100 <Waerk>").
		...
		opaTest("MasterList Filtering on Netwr more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 <Waerk>").
				and.iPressOKInViewSelectionDialog();
